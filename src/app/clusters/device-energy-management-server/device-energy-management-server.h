...
public:
    ...
    virtual Structs::PowerAdjustCapabilityStruct::Type & GetPowerAdjustmentCapability() = 0;
    ...
    virtual CHIP_ERROR SetPowerAdjustmentCapability(Structs::PowerAdjustCapabilityStruct::Type &) = 0;
