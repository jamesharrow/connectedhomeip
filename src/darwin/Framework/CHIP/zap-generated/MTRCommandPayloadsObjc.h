...
@property (nonatomic, copy) NSNumber * _Nullable enableChargeTime MTR_PROVISIONALLY_AVAILABLE;
...
@property (nonatomic, copy) NSNumber * _Nullable enableDischargeTime MTR_PROVISIONALLY_AVAILABLE;
