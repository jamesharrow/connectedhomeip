...
JNI_METHOD(void, EnergyEvseCluster, writeRandomisationDelayWindowAttribute)
(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback, jobject value, jobject timedWriteTimeoutMs)
{
    chip::DeviceLayer::StackLock lock;
    ListFreer listFreer;
    using TypeInfo = chip::app::Clusters::EnergyEvse::Attributes::RandomisationDelayWindow::TypeInfo;
    TypeInfo::Type cppValue;
...
JNI_METHOD(void, EnergyEvseCluster, writeApproxEvEfficiencyAttribute)
(JNIEnv * env, jobject self, jlong clusterPtr, jobject callback, jobject value, jobject timedWriteTimeoutMs)
{
    chip::DeviceLayer::StackLock lock;
    ListFreer listFreer;
    using TypeInfo = chip::app::Clusters::EnergyEvse::Attributes::ApproxEvEfficiency::TypeInfo;
    TypeInfo::Type cppValue;
