...
class EnergyEvseClusterEVNotDetectedEvent(
  ...
  val sessionEnergyCharged: Int,
  val sessionEnergyDischarged: Int
) {
  ...
  companion object {
    ...
    fun fromTlv(tlvTag: Tag, tlvReader: TlvReader): EnergyEvseClusterEVNotDetectedEvent {
      ...
      val sessionEnergyCharged = tlvReader.getInt(ContextSpecificTag(TAG_SESSION_ENERGY_CHARGED))
      val sessionEnergyDischarged =
        tlvReader.getInt(ContextSpecificTag(TAG_SESSION_ENERGY_DISCHARGED))
