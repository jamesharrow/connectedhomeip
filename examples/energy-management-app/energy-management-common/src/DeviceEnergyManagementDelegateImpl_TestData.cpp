...
static void FillForecast(DataModel::Nullable<Structs::ForecastStruct::Type> & nullableForecast)
{
    ...
    forecast.earliestStartTime = Optional<DataModel::Nullable<uint32_t>>{ DataModel::Nullable<uint32_t>{
        56789 } }; // Optional<DataModel::Nullable<uint32_t>>
    ...
    gSlot[1].costs =
        Optional<DataModel::List<const Structs::CostStruct::Type>>{ DataModel::List<const Structs::CostStruct::Type>() };
